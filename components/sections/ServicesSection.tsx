...
export function ServicesSection() {
  return (
    <section className="rounded-t-[40px] bg-white px-5 py-20 text-background sm:rounded-t-[50px] sm:px-8 sm:py-24 md:rounded-t-[60px] md:px-10 md:py-32">
      <FadeIn>
      ...
      <div className="mx-auto max-w-5xl border-y border-background/15">
        {services.map((service, index) => (
          <FadeIn key={service.name} delay={index * 0.1} y={40}>
            <div className="grid gap-6 border-b border-background/15 py-8 last:border-b-0 sm:py-10 md:grid-cols-[0.35fr_1fr] md:py-12">
              <span className="text-[clamp(3rem,10vw,140px)] font-black leading-none text-background">
