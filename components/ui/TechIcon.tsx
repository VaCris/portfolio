...
const techIcons: Record<string, IconConfig> = {
  ...
  html5: { src: `${DEVICON_BASE_URL}/html5/html5-original.svg` },
  css3: { src: `${DEVICON_BASE_URL}/css3/css3-original.svg` },

  //backend
  nestjs: { src: `${DEVICON_BASE_URL}/nestjs/nestjs-original.svg` },
  ...
  //bd
  sql: { src: `${DEVICON_BASE_URL}/sqldeveloper/sqldeveloper-original.svg` },
  ...
  gitlab: { src: `${DEVICON_BASE_URL}/gitlab/gitlab-original.svg` },
  postman: { src: `${DEVICON_BASE_URL}/postman/postman-original.svg` },
  "visual studio code": { src: `${DEVICON_BASE_URL}/vscode/vscode-original.svg` },
